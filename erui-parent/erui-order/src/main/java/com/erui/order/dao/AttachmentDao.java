...
public interface AttachmentDao extends JpaRepository<Attachment, Serializable>, JpaSpecificationExecutor<Attachment> {
    ...
    List<Attachment> findByRelObjIdAndCategory(Integer relObjId, String category);

   /* void updateByRelObjIdAndCategory(Integer relObjId, String category);

    void deleteByRelObjIdAndCategory(Integer relObjId, String category);
