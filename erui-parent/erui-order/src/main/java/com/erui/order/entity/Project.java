...
public class Project {
  ...
  */
    ...
    public static enum ProjectStatusEnum {
        ...
        DELAYED_UNSHIPPED("DELAYED_UNSHIPPED", "延期待发运", 8), PAUSE("PAUSE", "项目暂停", 9), CANCEL("CANCEL", "项目取消", 10), ORDERCANCEL("ORDERCANCEL", "订单取消", 11), TURNDOWN("TURNDOWN", "驳回", 12), CHANGE("CHANGE", "项目变更", 13);
        private String code;
        private String msg;
        private Integer num;
