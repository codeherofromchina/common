...
public enum ExcelUploadTypeEnum {
    ...
    PROJECT_MANAGE(3, "项目管理", new String[]{"订单id", "销售合同号", "项目开始日期", "合同标的", "执行单约定交付日期", "合同总价（USD）", "初步利润率", "利润额", "执行单变更后日期", "要求采购到货日期", "有无项目经理", "下发部门id", "下发部门", "项目状态", "采购经办人编号", "采购经办人", "品控经办人编号", "品控经办人", "商务技术经办人编号", "商务技术经办人", "交付配送中心项目经理编号", "交付配送中心项目经理", "项目备注"}),
    ...
    public static void main(String[] args) {
        ...
        String[] s = {"订单类别", "海外销类型", "销售合同号", "框架协议号", "海外销售合同号", "PO号", /*"物流报价单号",去掉*/
                ...
                "项目开始日期", "合同标的", "执行单约定交付日期", "合同总价（USD）", "初步利润", "利润额", "执行单变更后日期", "有无项目经理", "下发部门", "项目状态",
