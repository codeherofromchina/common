...
public class CheckLog {
    ...
    public enum AuditProcessingEnum {
        ...
        P1(3, 20, 20, "提交审核"), P2(3, 21, 21, "采购经理审核"), P3(3, 22, 22, "商务技术审核"), P4(3, 23, 23, "法务审核"), P5(3, 24, 24, "财务审核"), P6(3, 25, 25, "供应链中心总经理审核"), P7(3, 26, 26, "总裁审核"), P8(3, 27, 27, "董事长审批"), ZZ(0, 999, 999, "已完成");
        int type;
        int process;
        String name;
        float auditSeq;
