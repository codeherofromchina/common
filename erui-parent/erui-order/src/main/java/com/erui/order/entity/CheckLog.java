...
public class CheckLog {
    ...
    public enum AuditProcessingEnum {
        ...
        A(1, 0, "市场经办人"), B(1, 1, "回款责任人审核"), C(1, 2, "国家负责人审核"), D(1, 3, "区域负责人审核"), E(1, 4, "区域VP审核"), F(1, 5, "融资专员审核"), F2(1, 6, "商务技术经办人"), G(2, 1, "事业部利润核算"),
        H(2, 2, "法务审核"), I(2, 3, "财务审核"), J(2, 4, "结算审核"), K(2, 5, "物流审核"), L(2, 6, "事业部总监审核"), M(2, 7, "事业部VP审核"), N(2, 8, "总裁审核"), O(2, 9, "董事长审核");
        int type;
        int process;
        String name;
