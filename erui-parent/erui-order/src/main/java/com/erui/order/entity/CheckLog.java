...
public class CheckLog {
    ...
    public enum AuditProcessingEnum {
        ...
        P1(3, 20, 20, "提交审核"), P2(3, 21, 21, "采购经理审核"), P3(3, 22, 22, "事业部项目负责人"), P4(3, 23, 23, "法务审核"), P5(3, 24, 24, "财务审核"), P6(3, 25, 25, "供应链中心总经理审核"), P7(3, 26, 26, "总裁审核"), P8(3, 27, 27, "董事长审核"),
        DE1(4, 30, 30, "提交审核"), DE2(4, 31, 31, "国家负责人审核"), DE3(4, 32, 32, "结算专员审核"), DE4(4, 33, 33, "事业部项目负责人审核"), DE5(4, 34, 34, "物流负责人审核"), ZZ(0, 999, 999, "已完成"),
        O1(1, 100, 100, "市场经办人"), O2(1, 101, 101, "国家负责人审核"), O3(1, 102, 102, "地区总经理审核"), O4(1, 103, 103, "分管领导审核"), O5(1, 104, 104, "融资专员审核"), O6(1, 105, 105, "法务审核"), O7(1, 106, 106, "结算审核"), O8(1, 201, 201, "事业部利润核算"), O9(1, 999, 999, "已完成"),
        NEW_PRO_BUSINESS_SUBMIT(2, 201, 201, "商务技术提交项目"), NEW_PRO_LOGISTICS(2, 202, 202, "物流经办人审核"), NEW_PRO_BUSINESS(2, 203, 203, "事业部项目负责人审核"), NEW_PRO_PURCHASE(2, 204, 204, "采购经办人审核"), NEW_PRO_QA(2, 205, 205, "品控经办人审核"), NEW_PRO_MANAGER(2, 206, 206, "事业部总经理审核"), NEW_PRO_CEO(2, 207, 207, "总裁审核"), NEW_PRO_CHAIRMAN(2, 208, 208, "董事长审核"), NEW_PRO_DONE(2, 999, 999, "已完成");
