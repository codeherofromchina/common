...
public class BackLog {
    ...
    */
    ...
    public static enum ProjectStatusEnum {
        ...
        INSTOCKSUBMENU("INSTOCKSUBMENU", "办理分单", 7),TRANSACTINSTOCK("TRANSACTINSTOCK", "办理入库", 7),DELIVERDETAILQUALITY("DELIVERDETAILQUALITY", "办理出库质检", 8),
         PAUSE("PAUSE", "项目暂停", 9), CANCEL("CANCEL", "项目取消", 10), TURNDOWN("TURNDOWN", "驳回", 11);
        private String code;
        private String msg;
