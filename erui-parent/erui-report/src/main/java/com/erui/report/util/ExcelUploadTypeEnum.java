...
public enum ExcelUploadTypeEnum {
	...
	STORAGE_ORGANICOUNT(3, "仓储物流-事业部",new String[]{"时间","事业部","托盘数量","产品数量","备注"}), 
	HR_COUNT(4,"人力资源",new String[]{"日期","部门","计划人数","在编人数","试用期人数","转正人数","中方","外籍","新进","集团转岗（进）","集团转岗（出）","离职"}), 
	INQUIRY_COUNT(5, "客户中心-询单",new String[]{"序号","报价单号","询价单位","所属地区部","事业部","客户名称或代码","客户及项目背景描述","品名中文","品名外文","规格","图号","数量","单位","油气or非油气","平台产品分类","产品分类","是否科瑞设备用配件","是否投标","转入日期","需用日期","澄清完成日期","报出日期","报价用时","市场负责人","商务技术部报价人","事业部负责人","产品品牌","报价单位","供应商报价人","报价人联系方式","厂家单价（元）","厂家总价（元）","利润率","报价单价（元）","报价总价（元）","报价总金额（美金）","单重(kg)","总重(kg)","包装体积(mm)","包装方式","交货期（天）","有效期（天）","贸易术语","最新进度及解决方案","报价后状态","备注","报价超48小时原因类型","报价超48小时分析","成单或失单	失单原因类型","失单原因分析"}), 
