...
public enum ExcelUploadTypeEnum {
	...
	ORDER_ENTRY_COUNT(9, "仓储物流-订单入库",new String[]{"入库单号","项目执行号","采购通知单号","数量","金额","入库时间","备注","单据类型","库存总量"}),
	ORDER_OUTBOUND_COUNT(10,"仓储物流-订单出库",new String[]{"出库单号","采购通知单号","目的国","项目执行号","包装件数","出库时间","金额","备注","单据类型"}),
	PROCUREMENT_COUNT(11,"采购",new String[]{"采购申请单下达时间","合同签订时间","采购计划单号","合同号","金额(美元)","品类","区域","国家","油气非油气"}),
	...
	SALES_PERFORMANCE(15, "销售业绩",new String[]{"序号","执行单号","海外销号","签约主体","未用易瑞签约原因","是否通过代理商获取","代理商代码","事业部","执行分公司","所属地区部","客户代码","品名中文","产品分类","数量","单位","项目金额（美元）","初步利润率","回款方式","项目开始","获取主体单位","获取人","市场经办人","商务技术部经办人","备注"}),
	CHECK_PROFIT(16, "报价利润核算单",new String[]{"序号"}),
	ORDER_CONTRACT(18, "国际销售合同签订审批表V3.0",new String[]{"序号"});
