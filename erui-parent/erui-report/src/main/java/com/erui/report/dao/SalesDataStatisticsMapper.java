...
public interface SalesDataStatisticsMapper {
     ...
     * @return
     */
    List<Map<String, Object>> agencySupplierTotalAmountByCountry(Map<String, Object> params);
     ...
     * @return
     */
    List<Map<String, Object>> agencySupplierTotalAmountByOrg(Map<String, Object> params);
     ...
     * @return
     */
    List<Map<String, Object>> agencySupplierTotalAmountByArea(Map<String, Object> params);
    ...
    List<Map<String, Object>> newMemberQuoteNumGroupByArea(Map<String, Object> params);
    ...
    List<Map<String, Object>> newMemberInquiryNumGroupByArea(Map<String, Object> params);
    ...
    List<Map<String, Object>> newMemberQuoteAmountGroupByArea(Map<String, Object> params);
     ...
     *
     * @param params
     * @return {"id":"记录ID","buyer_code":"客户编码","country_bn":"国家编码","countryName":"国家名称","area_bn":"地区编码","areaName":"地区名称","created_at":"采购时间","maxQuotePrice":"单笔订单最大金额","totalQuotePrice":"采购总金额"}
     */
